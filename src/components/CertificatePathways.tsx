    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 md:gap-10 mb-14 md:mb-20">
          <h2 className="text-3xl md:text-4xl lg:text-[44px] font-semi_bold_24pt text-[#00173C] leading-[1.15] tracking-tight min-w-0">
            Certificate Pathways
          </h2>
          <p className="text-[#6B7585] font-regular_18pt text-base md:text-[17px] leading-relaxed max-w-md md:text-right min-w-0">
