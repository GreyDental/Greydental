...
const navItems = [
  ...
  { label: "Assignments", icon: "Icon (11).svg", href: "/student-dashboard", match: "/student-dashboard/assignments" },
  { label: "Certificates", icon: "Icon (12).svg", href: "/student-dashboard", match: "/student-dashboard/certificates" },
  { label: "Community", icon: "Icon (13).svg", href: "/community", match: "/community" },
