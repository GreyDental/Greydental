      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-16 gap-8">
          ...
          <div className="flex-1 lg:max-w-md">
            <p className="text-gray-500 font-regular_18pt text-base md:text-[17px] leading-relaxed">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {categories.map((cat, idx) => (
            <div
              key={idx}
              className="bg-white rounded-[24px] overflow-hidden shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 flex flex-col h-full hover:shadow-[0_12px_40px_rgb(0,0,0,0.08)] transition-shadow duration-300"
            >
              {/* Card Image */}
