...
export default function InstructorsCta() {
  return (
    <section
      id="join-faculty"
      className="w-[100vw] relative left-1/2 -translate-x-1/2 bg-[#F9FCFE] pt-14 sm:pt-16 md:pt-20 lg:pt-24 pb-0 overflow-x-hidden flex flex-col"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 w-full min-w-0 flex flex-col lg:flex-row lg:items-end gap-10 sm:gap-12 lg:gap-10 xl:gap-14">
        ...
        <div className="flex flex-col flex-1 min-w-0 w-full items-start text-left order-1 lg:self-center pb-10 sm:pb-12 lg:pb-16 xl:pb-20">
          <h2 className="text-[26px] sm:text-3xl md:text-4xl lg:text-[44px] font-semi_bold_24pt text-[#00173C] leading-[1.15] tracking-tight mb-4 sm:mb-5 max-w-xl">
            Share Your Expertise with the Next Generation
          </h2>

          <p className="text-[#6B7585] font-regular_18pt text-[14px] sm:text-[15px] md:text-[16px] leading-relaxed max-w-lg mb-7 sm:mb-8">
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4 w-full sm:w-auto min-w-0">
            <Link
              href="/about"
              className="inline-flex items-center justify-center w-full sm:w-auto bg-[#00173C] hover:bg-[#08386D] text-white px-5 sm:px-6 py-3 sm:py-3.5 rounded-[10px] font-inter-medium_18pt text-[14px] sm:text-[15px] transition-colors"
            >
              Apply as an Instructor
            </Link>
            <Link
              href="/community"
              className="inline-flex items-center justify-center w-full sm:w-auto bg-transparent border border-[#00173C] text-[#00173C] hover:bg-[#00173C] hover:text-white px-5 sm:px-6 py-3 sm:py-3.5 rounded-[10px] font-inter-medium_18pt text-[14px] sm:text-[15px] transition-colors"
            >
              Contact Our Team
            </Link>
          </div>
