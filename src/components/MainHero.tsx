      ...
      <div className="w-full flex flex-col lg:flex-row items-center justify-between gap-8 sm:gap-12 px-4 sm:px-6 pb-14 sm:pb-20">
        ...
        <div className="flex-1 min-w-0 flex flex-col items-start text-left max-w-2xl w-full">
          ...
          <div className="flex flex-col sm:flex-row flex-wrap items-stretch sm:items-center gap-3 sm:gap-4 w-full sm:w-auto">
            <Link
              href="/courses"
              className="bg-blueBtnBg hover:opacity-90 inline-flex items-center justify-center h-[46px] px-6 rounded-[4px] text-[15px] font-inter-medium_18pt transition-opacity duration-200 w-full sm:w-auto text-white"
            >
              Explore courses
            </Link>
            <Link
              href="/community"
              className="border border-blueText hover:bg-gray-50 inline-flex items-center justify-center h-[46px] px-6 rounded-[4px] text-[15px] font-inter-medium_18pt transition-colors duration-200 w-full sm:w-auto text-blueText"
            >
              Join Community
            </Link>
          </div>
        ...
        {/* Hero Image */}
        <div className="flex-1 min-w-0 flex justify-center lg:justify-end relative w-full">
          <Image
