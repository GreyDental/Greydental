      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 flex flex-col gap-8 sm:gap-10 w-full min-w-0">
        ...
        <div className="flex flex-col lg:flex-row gap-8 sm:gap-10 lg:gap-14 items-start w-full min-w-0">
          ...
          <div className="relative flex w-full max-w-[320px] sm:max-w-[360px] lg:w-[340px] lg:max-w-none lg:flex-shrink-0 mx-auto lg:mx-0 min-w-0">
            <div className="relative w-full aspect-[4/5] rounded-[20px] sm:rounded-[24px] overflow-hidden shadow-[0_12px_32px_rgba(58,115,141,0.1)] border-l-[4px] border-l-[#7ED9B5]">
              <Image
          ...
          <div className="flex flex-col flex-1 min-w-0 pt-1 w-full">
            <h3 className="text-[24px] sm:text-[28px] md:text-[32px] font-semi_bold_24pt text-[#3A738D] leading-tight tracking-tight mb-2">
              Dr. Sarah Thompson
            </h3>

            <p className="text-[#777779] text-[12px] sm:text-[13px] font-semi_bold_24pt tracking-[0.12em] uppercase mb-5 sm:mb-6">
              MDS, PH.D. ENDODONTICS
            </p>

            <div className="flex flex-col gap-4 sm:gap-5 text-[#777779] font-regular_18pt text-[14px] sm:text-[15px] md:text-[16px] leading-relaxed max-w-2xl mb-6 sm:mb-8">
              <p>
            ...
            <Link
              href="/instructors"
              className="inline-flex items-center gap-1.5 self-start text-[#3A738D] font-inter-medium_18pt text-[15px] hover:opacity-80 transition-opacity"
            >
              View Profile
