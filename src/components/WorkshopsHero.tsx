      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-10 sm:py-14 md:py-20 lg:py-24 w-full min-w-0">
        <div className="flex flex-col lg:flex-row lg:items-center gap-8 sm:gap-10 lg:gap-12 xl:gap-16 w-full min-w-0">
          ...
          <div className="flex flex-col flex-1 min-w-0 w-full items-start text-left order-1">
            ...
            <p className="text-[#777779] font-regular_18pt text-[14px] sm:text-[15px] md:text-[16px] leading-relaxed max-w-md mb-6 sm:mb-7 md:mb-8">
            ...
            <Link
              href="#upcoming"
              className="inline-flex items-center justify-center gap-2 w-full sm:w-auto bg-[#3A738D] text-white px-5 sm:px-6 py-3 sm:py-3.5 rounded-[10px] font-inter-medium_18pt text-[14px] sm:text-[15px] hover:opacity-90 transition-opacity"
            >
              Reserve your spot
              ...
              <div className="relative z-10 flex w-full rounded-[16px] sm:rounded-[20px] md:rounded-[24px] overflow-hidden shadow-[0_16px_40px_rgba(58,115,141,0.12)] aspect-[4/3] sm:aspect-[5/4]">
                ...
                >
                  <div className="flex items-center gap-1.5 min-w-0">
                    <span className="w-2 h-2 rounded-full bg-[#5ECAA0] flex-shrink-0" />
                    <span className="text-[#3A738D] font-semi_bold_24pt text-[11px] sm:text-[12px] md:text-[13px] leading-none truncate">
                      Live in 3 days
                    </span>
                  </div>
                  <span className="text-[#777779] font-regular_18pt text-[10px] sm:text-[11px] md:text-[12px] pl-[14px] leading-tight truncate">
                    Clinical Skills Day
                  </span>
                </div>
              </div>
