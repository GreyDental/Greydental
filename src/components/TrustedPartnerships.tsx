      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 w-full min-w-0 flex flex-col items-center">
        ...
        <div className="flex flex-col sm:flex-row sm:flex-wrap gap-4 sm:gap-5 w-full min-w-0">
          {partners.map((partner) => (
            <article
              key={partner.name}
              className="flex flex-col items-center justify-center min-w-0 w-full sm:w-[calc(50%-0.625rem)] lg:w-[calc(25%-0.9375rem)] min-h-[140px] sm:min-h-[160px] md:min-h-[180px] bg-[#F4F7F8] border border-[#E5E7EB] rounded-[12px] sm:rounded-[14px] px-5 sm:px-6 py-6 sm:py-8"
              style={{
                boxShadow:
