        ...
        <div className="flex flex-col lg:flex-row lg:items-center gap-8 sm:gap-10 lg:gap-12 xl:gap-16 w-full min-w-0">
          ...
          <div className="flex flex-col flex-1 min-w-0 w-full items-start text-left order-1">
            <div className="inline-flex items-center bg-white border border-[#E9E9E9] px-4 py-1.5 rounded-full mb-4 sm:mb-5 md:mb-6">
              <span className="text-[11px] sm:text-[12px] font-semi_bold_24pt tracking-[0.12em] text-[#3A738D] uppercase">
                Resource Library
              </span>
            </div>

            <h1 className="text-[28px] sm:text-4xl md:text-5xl lg:text-[52px] font-semi_bold_24pt text-[#3A738D] leading-[1.15] tracking-tight mb-3 sm:mb-4 md:mb-5 max-w-xl">
              Everything you need between courses
            </h1>

            <p className="text-[#777779] font-regular_18pt text-[14px] sm:text-[15px] md:text-[16px] leading-relaxed max-w-lg mb-6 sm:mb-7 md:mb-8">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 w-full sm:w-auto min-w-0">
              <Link
                href="#newsletter"
                className="inline-flex items-center justify-center gap-2 w-full sm:w-auto bg-[#2F5F75] hover:bg-[#3A738D] text-white px-5 sm:px-6 py-3 sm:py-3.5 rounded-[10px] font-inter-medium_18pt text-[14px] sm:text-[15px] transition-colors"
              >
                Subscribe to APEX
              ...
              <Link
                ...
                className="inline-flex items-center justify-center w-full sm:w-auto bg-white border border-[#3A738D] text-[#3A738D] hover:bg-[#3A738D] hover:text-white px-5 sm:px-6 py-3 sm:py-3.5 rounded-[10px] font-inter-medium_18pt text-[14px] sm:text-[15px] transition-colors"
              >
          ...
          <div className="relative flex justify-center lg:justify-end w-full max-w-[380px] sm:max-w-[440px] md:max-w-[480px] lg:max-w-[520px] lg:w-[48%] lg:flex-shrink-0 mx-auto lg:mx-0 order-2 min-w-0 pt-3 pl-3 sm:pt-4 sm:pl-4">
            <div className="relative w-full min-w-0">
              ...
              <div className="relative z-10 flex w-full rounded-[16px] sm:rounded-[20px] md:rounded-[24px] overflow-hidden shadow-[0_16px_40px_rgba(58,115,141,0.12)] aspect-[4/3] sm:aspect-[5/4]">
                <Image
