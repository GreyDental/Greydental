    ...
    <section className="w-[100vw] relative left-1/2 -translate-x-1/2 bg-greyBg py-24">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="flex flex-col lg:flex-row gap-6">
          ...
          <div className="relative h-[320px] sm:h-[400px] lg:h-[500px] rounded-[24px] sm:rounded-[32px] overflow-hidden group cursor-pointer shadow-[12px_12px_24px_rgba(0,0,0,0.1)] w-full lg:flex-[3]">
            <Image 
          ...
          {/* Right Cards Stack */}
          <div className="flex flex-col gap-6 w-full lg:flex-[2]">
            {/* Top Right Card: Hybrid Residency */}
            <div className="flex-1 bg-white rounded-[24px] sm:rounded-[32px] p-6 sm:p-8 flex flex-col justify-center border border-gray-100 shadow-[12px_12px_24px_rgba(0,0,0,0.06)] hover:shadow-[16px_16px_32px_rgba(0,0,0,0.1)] transition-shadow cursor-pointer min-h-[160px]">
            ...
            <div className="flex-1 bg-blueBg rounded-[24px] sm:rounded-[32px] p-6 sm:p-8 flex flex-col justify-center shadow-[12px_12px_24px_rgba(0,0,0,0.15)] hover:shadow-[16px_16px_32px_rgba(0,0,0,0.25)] transition-shadow cursor-pointer min-h-[160px]">
