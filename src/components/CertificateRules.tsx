      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 w-full">
        <div className="flex flex-col lg:flex-row lg:items-center gap-10 sm:gap-12 lg:gap-16 w-full min-w-0">
          ...
          <div className="flex flex-col flex-1 min-w-0 w-full">
            <h2 className="text-[28px] sm:text-3xl md:text-4xl lg:text-[44px] font-semi_bold_24pt text-[#00173C] leading-[1.15] tracking-tight mb-3 sm:mb-4">
              Certificate Rules
            </h2>
            <p className="text-[#6B7585] font-regular_18pt text-[14px] sm:text-[15px] md:text-[16px] leading-relaxed max-w-xl mb-7 sm:mb-8">
            ...
            <div className="flex flex-col sm:flex-row sm:flex-wrap gap-3 sm:gap-4 w-full max-w-xl">
              {rules.map((rule) => (
                <div
                  key={rule}
                  className="flex flex-row items-center gap-3 w-full sm:w-[calc(50%-0.5rem)] min-w-0 bg-white rounded-[12px] px-4 py-3.5 sm:px-5 sm:py-4 shadow-[0_4px_16px_rgba(0,23,60,0.06)] border border-[#E8EEF4]/80"
                >
                  <Image
                  ...
                  />
                  <span className="text-[#00173C] font-inter-medium_18pt text-[13px] sm:text-[14px] leading-snug min-w-0">
                    {rule}
                  </span>
                </div>
              ))}
