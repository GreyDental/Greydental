...
export default function Footer() {
  return (
    <footer className="w-full bg-blueBg pt-20 pb-8 border-t border-[#0a234f]">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 lg:gap-8 mb-16">
          
          {/* Brand Column */}
          <div className="lg:col-span-2 pr-8">
            <h3 className="text-2xl font-semi_bold_24pt text-white mb-6">
              Grey Dental
            </h3>
            <p className="text-gray-400 font-regular_18pt text-[15px] leading-relaxed mb-8 max-w-sm">
          ...
          {/* About Column */}
          <div>
            <h4 className="text-[15px] font-semi_bold_24pt tracking-[0.1em] text-white uppercase mb-6">
              About
            </h4>
        ...
        {/* Bottom Bar */}
        <div className="pt-8 border-t border-[#102b5e] flex flex-col md:flex-row justify-center items-center">
          <p className="text-gray-500 font-regular_18pt text-[14px]">
