    ...
    <section className="w-[100vw] relative left-1/2 -translate-x-1/2 bg-[#F9FCFE] py-12 sm:py-16 md:py-20 lg:py-24 overflow-x-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 w-full min-w-0">
        <div className="flex flex-col lg:flex-row gap-5 sm:gap-6 w-full min-w-0 items-start">
          {/* Featured Webinar */}
          <article className="flex flex-col flex-1 min-w-0 w-full bg-white rounded-[16px] sm:rounded-[20px] p-5 sm:p-6 md:p-8 shadow-[0_8px_24px_rgba(0,23,60,0.08)] border border-[#BCBCBC]">
            <div className="inline-flex self-start items-center border border-[#6B7585] px-3.5 py-1.5 rounded-full mb-4 sm:mb-5">
              <span className="text-[10px] sm:text-[11px] font-semi_bold_24pt tracking-[0.12em] text-[#08386D] uppercase">
                Featured Webinar
              </span>
            </div>

            <h2 className="text-[22px] sm:text-[26px] md:text-[28px] font-semi_bold_24pt text-[#00173C] leading-snug tracking-tight mb-3 sm:mb-4">
              Advanced Residency Webinar
            </h2>

            <p className="text-[#6B7585] font-regular_18pt text-[14px] sm:text-[15px] leading-relaxed mb-5 sm:mb-6 max-w-md">
            ...
            <div className="flex flex-col gap-2.5 sm:gap-3 mb-6 sm:mb-8">
              <div className="flex items-center gap-2.5 text-[#6B7585]">
                <Calendar
                  className="w-4 h-4 sm:w-[18px] sm:h-[18px] text-[#41F39B] flex-shrink-0"
                  strokeWidth={1.75}
                />
            ...
            <div className="mt-auto flex flex-col sm:flex-row gap-3 w-full min-w-0">
              ...
              <Link
                href="/workshops"
                className="inline-flex items-center justify-center flex-1 bg-white border border-[#051937] text-[#051937] hover:bg-[#051937] hover:text-white px-5 py-3 sm:py-3.5 rounded-[10px] font-inter-medium_18pt text-[14px] sm:text-[15px] transition-colors"
              >
                View All Events
              </Link>
            </div>
          ...
          {/* FAQ */}
          <article className="flex flex-col flex-1 min-w-0 w-full min-h-[440px] sm:min-h-[400px] lg:min-h-[450px] bg-white rounded-[16px] sm:rounded-[20px] p-5 sm:p-6 md:p-8 shadow-[0_8px_24px_rgba(0,23,60,0.08)] border border-[#BCBCBC]">
            <h2 className="text-[22px] sm:text-[26px] md:text-[28px] font-semi_bold_24pt text-[#08386D] leading-snug tracking-tight mb-4 sm:mb-5">
              ...
              {faqs.map((faq, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    >
                      <span className="text-[#00173C] font-semi_bold_24pt text-[14px] sm:text-[15px] md:text-[16px] leading-snug min-w-0">
                        {faq.question}
                      </span>
                      <ChevronDown
                        className={`w-4 h-4 sm:w-5 sm:h-5 text-[#6B7585] flex-shrink-0 transition-transform duration-200 ${
                          isOpen ? "rotate-180" : ""
                        }`}
                      />
                    </button>
                    ...
                    >
                      <p className="text-[#6B7585] font-regular_18pt text-[13px] sm:text-[14px] leading-relaxed pr-6">
                        {faq.answer}
                      </p>
                    </div>
                  </div>
